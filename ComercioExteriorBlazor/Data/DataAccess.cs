using ComercioExteriorBlazor.conectores;
...
namespace ComercioExteriorBlazor.Data
{
    public class DataAccess
    {
        dll_Gis.BaseDatos bd = new dll_Gis.BaseDatos();
        String conexionBD = String.Empty;
        String conexionBD_32 = String.Empty;
        static dll_Gis.Funciones fn = new dll_Gis.Funciones();
        ...
        public Boolean cons_UsuarioAcceso(string? correo, out Usuario user, out String msgError)
        {
            ...
            @params = new SqlParameter[1]; 
            @params[0] = new SqlParameter("@correo", correo); 
            try
            {
