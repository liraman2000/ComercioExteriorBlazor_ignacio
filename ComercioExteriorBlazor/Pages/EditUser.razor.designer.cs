...
namespace ComercioExteriorBlazor.Pages
{
    public partial class EditUserComponent : ComponentBase
    {
        ...
        public IEnumerable<ComercioExteriorBlazor.Models.Negocio> INegocio;
        public IEnumerable<ComercioExteriorBlazor.Models.Perfil> IRol;
        ...
        ComercioExteriorBlazor.Models.Usuario _usuario;
        protected ComercioExteriorBlazor.Models.Usuario usuario
        {
            get
            {
                return _usuario;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            usuario = new ComercioExteriorBlazor.Models.Usuario() { };
            ...
            if (da.cons_Perfil(out List<ComercioExteriorBlazor.Models.Perfil> negRol, out msgErrorNeg))
            {
                IRol = negRol;
    ...
    protected async System.Threading.Tasks.Task Form0Submit(ComercioExteriorBlazor.Models.Usuario args)
        {
            try
            {
                DataAccess da = new DataAccess();
