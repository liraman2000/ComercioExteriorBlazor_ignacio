...
namespace ComercioExteriorBlazor.Pages
{
    public partial class UsuariosComponent : ComponentBase
    {
       ...
       // [Inject]
        ...
        protected RadzenDataGrid<ComercioExteriorBlazor.Models.Usuario> grid0;
        ...
        ComercioExteriorBlazor.Models.Usuario _master;
        protected ComercioExteriorBlazor.Models.Usuario master
        {
            get
            {
                return _master;
        ...
        protected async void Grid0Render(DataGridRenderEventArgs<ComercioExteriorBlazor.Models.Usuario> args)
        {
        ...
        protected async System.Threading.Tasks.Task Grid0RowDoubleClick(DataGridRowMouseEventArgs<ComercioExteriorBlazor.Models.Usuario> args)
        {
            await DialogService.OpenAsync<EditUser>("Editar Usuario", new Dictionary<string, object>() { {"Id", args.Data.Id} });
            Load();
        }

        protected async System.Threading.Tasks.Task Grid0RowSelect(ComercioExteriorBlazor.Models.Usuario args)
        {
            master = args;
