...
namespace ComercioExteriorBlazor.Pages
{
    public partial class DataStageComponent : ComponentBase
    {
        ...
        protected RadzenDataGrid<ComercioExteriorBlazor.Models.Documento> grid0;
        ...
        ComercioExteriorBlazor.Models.Documento _documento;
        protected ComercioExteriorBlazor.Models.Documento documento // order
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(ComercioExteriorBlazor.Models.Documento args)//. Blazor.Models.Sample.Order args)
        {
            isEdit = false;
