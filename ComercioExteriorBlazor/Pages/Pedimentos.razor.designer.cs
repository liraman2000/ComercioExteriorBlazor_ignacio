...
namespace ComercioExteriorBlazor.Pages
{
    public partial class PedimentosComponent : ComponentBase
    {
        ...
        ComercioExteriorBlazor.Models.cDataStage _pedimento;
        protected ComercioExteriorBlazor.Models.cDataStage pedimento
        {
            get
            {
                return _pedimento;
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(ComercioExteriorBlazor.Models.cDataStage args)
        {
            isEdit = true;
