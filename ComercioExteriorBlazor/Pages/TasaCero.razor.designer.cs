...
namespace ComercioExteriorBlazor.Pages
{
    public partial class TasaCeroComponent : ComponentBase
    {
        ...
        protected RadzenDataGrid<ComercioExteriorBlazor.Models.cTasaCero> datagrid0;
        ...
        ComercioExteriorBlazor.Models.cTasaCero _tasaCero;
        protected ComercioExteriorBlazor.Models.cTasaCero tasaCero // order
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(ComercioExteriorBlazor.Models.cTasaCero args)//. Blazor.Models.Sample.Order args)
        {
            isEdit = false;
